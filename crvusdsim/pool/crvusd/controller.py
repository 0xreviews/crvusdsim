...
class Controller(SnapshotMixin):  # pylint: disable=too-many-instance-attributes
    ...
    def max_borrowable(self, collateral: int, N: int, current_debt: int = 0) -> int:
        ...
        # @todo
        # return min(
        #     x, STABLECOIN.balanceOf(self) + current_debt
    ...
    def _deposit_collateral(self, amount: int):
        """
    ...
    def remove_collateral(self, user: str, collateral: int, use_eth: bool = True):
        """
        ...
        self._withdraw_collateral(user, collateral, use_eth)
    ...
    def _liquidate(
        ...
        if debt > xy[0]:
            ...
            # if xy[0] > debt:
            #     STABLECOIN.transferFrom(AMM.address, user, unsafe_sub(xy[0], debt))
    ...
    def liquidate(self, user: str, min_x: int, use_eth: bool = True):
        """
        ...
        self._liquidate(user, min_x, discount, 10**18, use_eth, None, [])
    ...
    def collect_fees(self) -> int:
        ...
        # if borrowed_fees > 0:
        #     STABLECOIN.transferFrom(self.AMM.address, _to, borrowed_fees)
